...
const Cursor = ({ cx, cy, chartHeight, selectedValue }: Props) => {
    ...
    return (
        <Group>
            <Text x={cx} y={30} text={animatedText} font={font} color={'#222'} />
            <Path path={path} color="#E5E5E5" style="stroke" strokeJoin="bevel" strokeWidth={1} />
